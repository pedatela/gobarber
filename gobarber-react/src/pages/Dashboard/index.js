...
export default function Dashboard() {
  ...
  return (
    <Container>
      <header>
        <button onClick={handlePrevDate} type="button"><MdChevronLeft size={36} color="#FFF" /></button>
        <strong>{dateFormatted}</strong>
        <button onClick={handleNextDate} type="button"><MdChevronRight size={36} color="#FFF" /></button>
      </header>
